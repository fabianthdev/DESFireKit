#
#  Be sure to run `pod spec lint DESFireKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.license      = "Proprietary Software. Do not use unless permission has been granted by the owner."
